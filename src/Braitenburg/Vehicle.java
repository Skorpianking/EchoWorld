...
public class Vehicle extends SimulationBody {
    ...
    // Using set to hold detectedObjects, set guarentees we will not have duplicates
    ...
    /**
     * Called from render.  Must geed it the coordinates of the specific sensor you want to ray cast
    ...
    /**
     * Looks for objects.  May be able to drop the graphics piece later.  We only care about the ray intersections
     * with objects but, for now, it is nice to "see" where the rays intersect.
     *
     * @param g
     */
    private void detect(Graphics2D g) {
        // Following code block draws Rays out from each sensor
